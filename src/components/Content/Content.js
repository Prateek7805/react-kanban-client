...
export default function Content() {
    ...
    return (
        <>
            ...
            <HeaderNav dimension={[navHeight, setNavHeight]}/>
            <Container className='main-container' style={{top: navHeight}} fluid>

                <div id="ID_ADD_TASK" className="d-flex flex-column flex-md-row justify-content-start justify-content-md-evenly align-items-center p-1">
